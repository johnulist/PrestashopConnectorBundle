...
class HasValidCredentials extends Constraint
{
    ...
    /** @var string */
    public $messageRestNotValid      = 'pim_prestashop_connector.export.validator.rest_url_not_valid';

    /** @var string */
    public $messageXmlNotValid       = 'pim_prestashop_connector.export.validator.xml_not_valid';

    /** @var string */
    public $messageApiKey          = 'pim_prestashop_connector.export.validator.authentication_failed';
